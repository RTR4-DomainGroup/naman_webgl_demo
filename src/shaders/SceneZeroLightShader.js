...
const sceneZeroLightShader = {
    ...
    init: function () {
        ...
        var fragmentShaderSourceCode =
            ...
            "uniform float u_alphaBlendingSceneZero; \n" +
            ...
            "{ \n" +
                ...
                "{ \n" +
                    ...
                    // "vec3 mapped = vec3(1.0) - exp(-phong_ads_color * 1.0); \n" +
                    ...
                    "FragColor = vec4(phong_ads_color, u_alphaBlendingSceneZero); \n" +
        ...
        this.uniforms.alphaBlendingSceneZeroUniform = gl.getUniformLocation(this.shaderProgramObject, "u_alphaBlendingSceneZero");
