...
const staticModelShader = {
    ...
    init: function () {
            ...
            "    a_color_out = a_gr_color; \n" +
                ...
                "{ \n" +
                    ...
                    "{ \n" +
                        ...
                        "spotlightDistance[i] = length(u_spotlightPosition[i] - (a_position + a_instancePosition)); \n" +
                    "} \n" +
                    ...
                    "gl_Position = u_projectionMatrix * u_viewMatrix * u_modelMatrix * (a_position + a_instancePosition); \n" +
                "} \n" +

                "if(u_depthScene == 1)\n" +
                "{ \n" +
                    "gl_Position = lightSpaceMatrix * u_modelMatrix * (a_position + a_instancePosition); \n" +
                "} \n" +

                "if(u_depthQuadScene == 1)\n" +
                "{ \n" +
                    "gl_Position = (a_position + a_instancePosition); \n" +
                "} \n" +
        ...
        if (gl.getShaderParameter(vertexShaderObject, gl.COMPILE_STATUS) == false) {
            ...
            if (error.length > 0) {
                var errorStr = "ERROR: Static Model Vertex Shader Compilation: " + error;
                alert(errorStr);
                return (false);
            }
        }
        ...
        var fragmentShaderSourceCode =
            ...
            "N = normalize(transformedNormals); \n" +
        ...
        if (gl.getShaderParameter(fragmentShaderObject, gl.COMPILE_STATUS) == false) {
            ...
            if (error.length > 0) {
                var errorStr = "ERROR: Static Model Fragment Shader Compilation: " + error;
                alert(errorStr);
                return (false);
            }
        }
        ...
        gl.bindAttribLocation(this.shaderProgramObject, webGLMacros.DG_ATTRIBUTE_INSTANCE_POSITION, "a_instancePosition");
        ...
        if (gl.getProgramParameter(this.shaderProgramObject, gl.LINK_STATUS) == false) {
            ...
            if (error.length > 0) {
                var errorStr = "ERROR: Static Model Shader Program Object Linking: " + error;
                alert(errorStr);
                return (false);
            }
        }
        ...
        this.uniforms.contrastUniform = gl.getUniformLocation(this.shaderProgramObject, "contrast");
        ...
        //gl.uniform1i(this.uniforms.depthTextureSamplerUniform, 0);
